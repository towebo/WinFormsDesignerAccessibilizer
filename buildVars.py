...
addon_info = {
	...
	"addon_name": "WinFormsDesignerAccessibilizer",
	...
	"addon_sourceURL": "https://github.com/towebo/WinFormsDesignerAccessibilizer",
...
pythonSources = [
	"Addon/appModules/WinFormsDesignerAccessibilizer/*.py",
	"Addon/globalPlugins/WinFormsDesignerAccessibilizer/*.py"
]
